...
def evolution_only_u_component():
    ...
    init_population = partial(initial_population_only_u_rotations, source_matrix=source_matrix, max_radius=100.0,
                              radius_ticks=5, axis=(4, 5))
    ...
    meta_params = {'pop_size': 100, 'generations': 1000, 'bound_value': 10.0,
